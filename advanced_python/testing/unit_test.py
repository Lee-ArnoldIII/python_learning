...
class CurrencyTest(unittest.TestCase):
    ...
    def test_in_currency(self):
        ...
        # self.assertTrue(pounds.in_currency(pounds.amount) == pounds.amount / pounds.exchange_to_usd)
        # self.assertFalse(pounds.in_currency(pounds.amount) < pounds.amount / pounds.exchange_to_usd)
        # self.assertFalse(pounds.in_currency(pounds.amount) > pounds.amount / pounds.exchange_to_usd)
    ...
    def test_convert_to_usd(self):
        ...
        # self.assertTrue(pounds.to_usd() == pounds.amount * pounds.exchange_to_usd)
        # self.assertFalse(pounds.to_usd() < pounds.amount * pounds.exchange_to_usd)
        # self.assertFalse(pounds.to_usd() > pounds.amount * pounds.exchange_to_usd)
